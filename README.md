...
**Callback hell:**
 ...
 Callback Hell (also known as the Pyramid of Doom) is a common anti-pattern in JavaScript where multiple asynchronous callback functions are deeply nested inside one another
